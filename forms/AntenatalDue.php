...
<?php 	
$listQry = "SELECT DISTINCT(av.picmeno),ec.motheraadhaarname,av.avdueDate,ec.mothermobno, av.anvisitDate, ec.VillageId, ec.PanchayatId, av.createdBy, ec.picmeNo, ec.PhcId,ec.BlockId,ec.HscId FROM antenatalvisit av JOIN ecregister ec on ec.picmeNo=av.picmeno 
