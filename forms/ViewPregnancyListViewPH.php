...
<?php include ('require/header.php'); // Menu & Top Search
 if (isset($_GET['view'])) {
   ...
   $avqry = mysqli_query($conn, "SELECT id,picmeno FROM antenatalvisit WHERE picmeno='".$picmeNo."'");
    ...
    ?>
				<div class="errMsg" id="errMsg"></div>
               		<input type="hidden" name="id" value="<?php echo $id; ?>">
                        ...
                        <div class="col-4 mb-3">
                          <label class="form-label" for="basic-icon-default-password">MOTHER'S AADHAAR ID  <span style="color:red" class= "warning-message" id="warning-message"></span></label>
                          <div class="input-group input-group-merge">
                        ...
                        <div class="col-4 mb-3">
                          <label class="form-label" for="basic-icon-default-phone">MOTHER'S MOBILE NUMBER  <span style="color:red" class= "Mmobmessage" id="Mmobmessage"></span></label>
                          <div class="input-group input-group-merge">
                            <span id="basic-icon-default-mobile" class="input-group-text"
				...
				<?php if($pv == !''){ ?>
				<a href="../forms/PostnatalVisitDtlPH.php?History=<?php echo $picmeNo; ?>" >
				<button type="button" class="btn btn-primary btnForm">
                    <span class="bx bx-clinic"></span>&nbsp; Postnatal</button>
					
				</a>
				<?php } if($im == !''){ ?>
				<a href="../forms/ImmunizationDtlPH.php?History=<?php echo $picmeNo; ?>" >
					<button type="button" class="btn btn-primary btnForm">
				...
				<?php } if($av == !''){ ?>
				<a href="../forms/AntenatalVisitDtlPH.php?History=<?php echo $picmeNo; ?>" >
					<button type="button" class="btn btn-primary btnForm">
