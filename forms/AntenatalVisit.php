              ...
              if($ExeQuery) {
                       ...
                       ?>
                                   <tr>
                                    ...
                                    ?></td>
									                     <td><?php $pv = $row['placeofvisit']; 
                                    if($rt == 1) { echo "HSC";}elseif($rt == 2){ echo "PHC"; }
                                    elseif($rt == 3){ echo "UG PHC"; }elseif($rt == 4){ echo "GH"; }
                                    elseif($rt == 5){ echo "MCH"; }elseif($rt == 6){ echo "Private Hospital"; }
                                    elseif($rt == 7){ echo "PNH"; }
                                       ?></td>
