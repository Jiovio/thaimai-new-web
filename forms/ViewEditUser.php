...
if (!empty($uquery)) {
    echo "<script>alert('Updated Successfully');window.location.replace('http://admin.thaimaiyudan.org/forms/UserManagement.php');</script>";
  }
}
if (isset($_GET['del'])) {
  $id = $_GET['del'];
  ...
  $_SESSION['message'] = "User deleted!"; 
      echo "<script>alert('Deleted Successfully');window.location.replace('http://admin.thaimaiyudan.org/forms/UserManagement.php');</script>";
}
?>
          <!-- Content wrapper -->
