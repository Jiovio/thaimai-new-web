...
if (isset($_GET['view'])) {
  ...
  $motheraadhaarid = $An["motheraadhaarid"];
  ...
  $tsh = $An["Tsh"]; $TdDose = $An["TdDose"]; $Td2Dose = $An["Td2Dose"]; $Td1Date = $An["Td1Date"]; 
  $TdBoosterDate = $An["TdBoosterDate"]; $Covidvac = $An["Covidvac"]; 
...
//   $usgtakenStatus = str_replace('..', '', $usgStatus);
  ...
  $usgScanEdd = $An["usgScanEdd"];  $usgFundalHeight = $An["usgFundalHeight"];
...
if (! empty($_POST["editVisit"])) {
  $id =$_POST["id"]; $picmeno = $_POST["picmeno"]; $residenttype = $_POST["residenttype"]; 
  ...
  $fastingSugar = $_POST["fastingSugar"]; $postPrandial = $_POST["postPrandial"]; 
  $rbs = $_POST["Rbs"]; $gctStatus = $_POST["gctStatus"];  $gctValue = $_POST["gctValue"]; 
  $tsh = $_POST["Tsh"]; $TdDose = $_POST["TdDose"]; $Td2Dose = $_POST["Td2Dose"]; $Td1Date = $_POST["Td1Date"]; 
  $TdBoosterDate = $_POST["TdBoosterDate"]; $Covidvac = $_POST["Covidvac"]; 
 ...
 // Now let's move the uploaded image into the folder: image
  ...
  $usgScanEdd = $_POST["usgScanEdd"]; $usgFundalHeight = $_POST["usgFundalHeight"];
  ...
  $query = mysqli_query($conn,"UPDATE antenatalvisit SET picmeno='$picmeno',residenttype='$residenttype',physicalpresent='$physicalpresent',
...
if (isset($_GET['del'])) {
  ...
  header('location: AntenatalVisit.php');
}
?>
          <!-- Content wrapper -->
                ...
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                    ...
                    <div class="col-4 mb-3">
                        ...
                        <div class="col-4 mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            <?php $query = mysqli_query($conn,"SELECT av.motheraadhaarid, ec.husbandaadhaarname FROM antenatalvisit av join ecregister ec on ec.motheraadhaarid=av.motheraadhaarid WHERE av.motheraadhaarid=".$motheraadhaarid); 
                            while ($mid = mysqli_fetch_assoc($query)) {
			...
			<!-- <input type="hidden" name="id" value="<?php echo $id; ?>"> -->
					<div class="row">
						...
						<div class="col-4 mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <div class="input-group input-group-merge">
                            <select required name="urineTestStatus" id="urineTestStatus" class="form-select" disabled>
                           <?php   
				...
				<div class="col-4 mb-3">
                        ...
                        <div class="col-4 mb-3" id="takenStatus">
						 ...
						 <div class="col-4 mb-3" id="usgDDate">
						...
						<div class="col-4 mb-3" id="ScanEdd">
			        	...
			        	<div class="col-4 mb-3" id="FundalHeight" >
						 ...
						 <div class="col-4 mb-3" id="SizeUterusWeek" >
                          ...
                          <div class="input-group input-group-merge">
                            <input
                              ...
                              />
						           ...
						           <div class="col-4 mb-3" id="FetusStatus" >
                          <label class="form-label" for="basic-icon-default-phone">USG Fetus Status</label>
                          <div class="input-group input-group-merge">
                          <select name="usgFetusStatus" id="usgFetusStatus" class="form-select" disabled>
                          <?php
                         ...
                         <?php 
                          ...
                          <option value="<?php echo $listvalue['enumid']; ?>"><?php echo $listvalue['enumvalue']; ?></option>
                               <?php } } ?>
						           ...
						           <div class="col-4 mb-3" id="placentaa" >
                          <label class="form-label" for="basic-icon-default-phone">Placenta</label>
                          <div class="input-group input-group-merge">
                          <select name="placenta" id="placenta" class="form-select" disabled>
                          <?php
                         ...
                         <?php 
                          ...
                          <option value="<?php echo $listvalue['enumid']; ?>"><?php echo $listvalue['enumvalue']; ?></option>
                               <?php } } ?>
						             ...
						             <div class="col-4 mb-3" id="Result" >
                          <label class="form-label" for="basic-icon-default-usgResult">USG Result</label>
                          <div class="input-group input-group-merge">
                          <select name="usgResult" id="usgResult" class="form-select" disabled>
                          <?php
