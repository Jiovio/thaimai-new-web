...
$motherCovidVac1Done =""; $motherCovidVac1Type=""; $motherCovidVac1Date=""; $motherCovidVac2Done=""; $motherCovidVac2Type="";
$motherCovidVac2Date=""; $motherCovidVacBoosterDone=""; $motherCovidVacBoosterType=""; $motherCovidVacBoosterDate="";
	$id = 0;
  $view = false;
	$update = false;
  if (isset($_GET['view'])) {
...
doseProvidedDate='$doseProvidedDate',futureDoseNo='$FutureDoseNo',futureDoseDate='$FutureDoseDate', breastFeeding='$breastFeeding', compliFoodStart='$compliFoodStart', motherCovidVac1Done='$motherCovidVac1Done'
, motherCovidVac1Type='$motherCovidVac1Type',motherCovidVac1Date='$motherCovidVac1Date', NextDoseName1='$NextDoseName1',motherCovidVac2Done='$motherCovidVac2Done', motherCovidVac2Type='$motherCovidVac2Type',
motherCovidVac2Date='$motherCovidVac2Date',Fcov2DueDate='$Fcov2DueDate',motherCovidVacBoosterDone='$motherCovidVacBoosterDone',motherCovidVacBoosterType='$motherCovidVacBoosterType',
motherCovidVacBoosterDate='$motherCovidVacBoosterDate',FBcovDueDate='$FBcovDueDate',updatedat='$date',updUserId='$userid' WHERE id=$id");

if (!empty($query)) { ?> 
  <div class="alert alert-success alert-dismissible"><h6><i class="icon fa fa-check"></i>Updated Successfully</h6></div>
<?php  header('location: Immunization.php');
} else { ?>
