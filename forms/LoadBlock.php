...
JOIN hscmaster hs on ecregister.BlockId = hs.BlockId AND
                     ecregister.PhcId = hs.PhcId     AND 
					ecregister.HscId =hs.HscId      AND 
			        ecregister.PanchayatId =hs.PanchayatId AND 
					ecregister.VillageId = hs.VillageId
