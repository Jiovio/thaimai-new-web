...
WHERE ec.BlockId='".$bloName."' AND ec.status!=0");
...
ec.PanchayatId =hs.PanchayatId AND 
ec.VillageId = hs.VillageId
WHERE ec.BlockId='".$bloName."' AND ar.status=1");
$ArCnt = mysqli_fetch_array($ArCntmq);

$AvCntmq = mysqli_query($conn,"SELECT COUNT(DISTINCT(av.picmeno)) AS AvCnt FROM antenatalvisit av JOIN ecregister ec ON av.picmeno=ec.picmeno 
JOIN hscmaster hs on
ec.BlockId = hs.BlockId AND 
ec.PhcId = hs.PhcId AND 
ec.HscId =hs.HscId AND 
ec.PanchayatId =hs.PanchayatId AND 
ec.VillageId = hs.VillageId
WHERE ec.BlockId='".$bloName."' AND av.status=1");
...
ec.PanchayatId =hs.PanchayatId AND 
ec.VillageId = hs.VillageId
WHERE ec.BlockId='".$bloName."' AND mh.status=1");
...
WHERE ec.BlockId='".$bloName."' AND hr.status=1");
...
ec.PanchayatId =hs.PanchayatId AND 
ec.VillageId = hs.VillageId
WHERE ec.BlockId='".$bloName."' AND dd.status=1");
...
ec.PanchayatId =hs.PanchayatId AND 
ec.VillageId = hs.VillageId
WHERE ec.BlockId='".$bloName."' AND im.status=1");
...
ec.PanchayatId =hs.PanchayatId AND 
ec.VillageId = hs.VillageId
WHERE ec.BlockId='".$bloName."' AND pv.status=1");
