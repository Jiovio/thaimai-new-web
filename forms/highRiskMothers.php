...
$listQry = "SELECT DISTINCT(hr.picmeNo), ec.BlockId, ec.PhcId, ec.HscId, ec.mothermobno, hr.highRiskFactor, hr.status, hr.motherName From highriskmothers hr JOIN ecregister ec on hr.picmeNo = ec.picmeNo 
