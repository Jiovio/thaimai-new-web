...
//	av.ancPeriod = (SELECT max(CAST(av1.ancPeriod AS SIGNED)) From antenatalvisit av1 where av1.picmeno = av.picmeno)");
	...
	$listQry_AV_upd_13 = mysqli_query($conn, "UPDATE `highriskmothers` "
	 ...
	 OR (av.usgFetalHeartRate2 > '0' AND av.usgFetalHeartRate2 < '100') OR av.usgFetalHeartRate2 > '170' OR av.usgFetalPosition = '1' OR av.usgFetalPosition1 = '1' OR av.usgFetalPosition2 = '1' OR av.usgFetalMovement = '4' OR av.usgFetalMovement1 = '4' OR av.usgFetalMovement2 = '4'
