...
WHERE ec.BlockId='".$bloName."' AND ec.PhcId='".$phcName."' AND ec.HscId='".$hscName."' AND ec.status!=0");
...
ec.PanchayatId =hs.PanchayatId AND 
ec.VillageId = hs.VillageId
WHERE ec.BlockId='".$bloName."' AND ec.PhcId='".$phcName."' AND ec.HscId='".$hscName."' AND ar.status=1");
...
ec.PanchayatId =hs.PanchayatId AND 
ec.VillageId = hs.VillageId
WHERE ec.BlockId='".$bloName."' AND ec.PhcId='".$phcName."' AND ec.HscId='".$hscName."' AND av.status=1");
...
ec.PanchayatId =hs.PanchayatId AND 
ec.VillageId = hs.VillageId
WHERE ec.BlockId='".$bloName."' AND ec.PhcId='".$phcName."' AND ec.HscId='".$hscName."' AND mh.status=1");
...
WHERE ec.BlockId='".$bloName."' AND ec.PhcId='".$phcName."' AND ec.HscId='".$hscName."' AND hr.status=1");
...
ec.PanchayatId =hs.PanchayatId AND 
ec.VillageId = hs.VillageId
WHERE ec.BlockId='".$bloName."' AND ec.PhcId='".$phcName."' AND ec.HscId='".$hscName."' AND dd.status=1");
...
ec.PanchayatId =hs.PanchayatId AND 
ec.VillageId = hs.VillageId
WHERE ec.BlockId='".$bloName."' AND ec.PhcId='".$phcName."' AND ec.HscId='".$hscName."' AND im.status=1");
...
ec.PanchayatId =hs.PanchayatId AND 
ec.VillageId = hs.VillageId
WHERE ec.BlockId='".$bloName."' AND ec.PhcId='".$phcName."' AND ec.HscId='".$hscName."' AND pv.status=1");
...
AND NOT EXISTS (SELECT deliverydetails.picmeno FROM deliverydetails WHERE deliverydetails.picmeno = ec.picmeNo) AND ec.BlockId='".$bloName."' AND ec.PhcId='".$phcName."' AND ec.HscId='".$hscName."'");
