...
if (!empty($query)) {
            echo "<script>alert('Updated Successfully');window.location.replace('http://localhost/thaimainew/forms/DeliveryDetails.php');</script>";
          } }
...
$_SESSION['message'] = "User deleted!"; 
  echo "<script>alert('Deleted Successfully');window.location.replace('http://localhost/thaimainew/forms/DeliveryDetails.php');</script>";
}
?>
 <!-- Content wrapper -->
