...
$query = mysqli_query($conn,"UPDATE deliverydetails SET picmeno='$picmeno',deliverydate='$deliverydate',
...
birthHeight='$birthHeight',DelayedCClamping='$delayedCClamping',PHCskintoskinContact='$skintoskinContact',
breastfeedInitiated='$breastfeedInitiated',admittedSncu='$admittedSncu',PHCsncudate='$sncudate',PHCsncuAreaName='$sncuAreaName',
PHCsncuOutcome='$sncuOutcome',Dischargedate='$dischargedate',Dischargetime='$dischargetime',bcgdate='$bcgdate',
...
<?php  header('location: DeliveryDetails.php');
} else { ?>
...
?>
 <!-- Content wrapper -->
            ...
            <div class="col-6 mb-3">
                ...
                <div class="row">
                        ...
                        <div class="col-6 mb-3">
                         ...
                         <option value="1">HscId</option>
                          <option value="2">VillageId</option>
                          <option value="3">UGVillageId</option>
                          <option value="4">GH</option>
                          <option value="5">MCH</option>
                          <option value="6">Private Hospital</option>
                          <option value="5">PNH</option>
  ...
  var selectedValue = selectBox.options[selectBox.selectedIndex].value;
    ...
    if(selectedValue == "1") { sdate.style.display = "BlockId"; }  else if(selectedValue == "0") { sdate.style.display = "none"; }
    if(selectedValue == "1") { sname.style.display = "BlockId"; }  else if(selectedValue == "0") { sname.style.display = "none"; }
    if(selectedValue == "1") { scome.style.display = "BlockId"; }   else if(selectedValue == "0") { scome.style.display = "none"; }
  }
      </script>
