  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <!-- Content wrapper -->
      <div class="content-wrapper">
        ...
        <label class="form-label" for="basic-icon-default-fullname">MOTHER AADHAAR ID <span class="mand">* </span></label>
        
        <div class="frmSearch">
        <div class="input-group input-group-merge">
        <span id="basic-icon-default-mobile" class="input-group-text">
        <i class="bx bx-id-card"></i></span>
        <input type="text" required id="motheraadhaarid" name="motheraadhaarid" onchange="showMoDet(this.value)" oninput = "onlyAadhar(this.value)" placeholder="MOTHER AADHAAR ID" class="form-control" />
        </div>
