<?php include "../config/db_connect.php"; ?>
  ...
  <!-- Search -->
		<form action="" method="post" id="filterform" style="width:96%";>	
            ...
            echo ">".$row["BlockName"]."</option>"; 
              ...
              <div class="col-md-2">
                  ...
                  <div class="input-group input-group-merge">
                  <select name="PhcId" id="PhcId" class='form-control' disabled>
			  <?php
				$result = mysqli_query($conn,"SELECT DISTINCT PhcId, PhcName FROM hscmaster WHERE PhcId='".$PhcId."'  ORDER BY PhcId;");
        while($row = mysqli_fetch_array($result)) {
      ...
      <div class="col-md-2">
				...
				<?php
				$result = mysqli_query($conn,"SELECT DISTINCT HscId, HscName FROM hscmaster WHERE HscId='".$HscId."'  ORDER BY HscName;");
        while($row = mysqli_fetch_array($result)) {
