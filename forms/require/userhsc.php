...
?>
  ...
  <!-- Search -->
		...
		<?php //print_r($_SESSION['HscId']."*".$_SESSION['PhcId']); ?>
      ...
      <div class="col-md-2">
              ...
              <?php
				$result = mysqli_query($conn,"SELECT DISTINCT BlockId, PhcId, PhcName FROM hscmaster WHERE BlockId='".$BlockId."' AND PhcId='".$PhcId."' ORDER BY PhcName;");
        while($row = mysqli_fetch_array($result)) {
