...
?>
  ...
  <!-- Search -->
		...
		<?php if($usertype == 5) { $BlockId = $_SESSION['BlockId']; if(isset($_POST['PhcId'])) {$PhcId = $_POST['PhcId'];}}?>
      ...
      <div class="col-md-2">
                  ...
                  <div class="input-group input-group-merge">
				  <?php /* if(isset($_POST['HscId'])){print_r("I am hscid");}
                        if(empty($_POST['reset'])){print_r("I am reset");}
						if(isset($_POST['filter'])){print_r("I am filter");}
                        if(isset($_SESSION['BlockId'])){print_r("I am Blockid");}   */
						//if(isset($_POST['PhcId'])){print_r("I am Phcid"."*".$_POST['PhcId']);}   
				   ?>
        ...
        //	    $result = mysqli_query($conn,"SELECT DISTINCT HscId, HscName FROM hscmaster WHERE BlockId='".$BlockId."' ORDER BY HscName;");
