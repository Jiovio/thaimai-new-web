...
<?php include ('require/header.php'); // Menu
   include ('require/Sfilter.php'); // Top Filter
		
      if(isset($_POST['filter'])) {
		
		$result = mysqli_query($conn,"SELECT lm.BlockId, lm.PhcId, lm.HscId FROM users u JOIN hscmaster lm on lm.BlockId=u.BlockId 
		WHERE 
		...
		print_r("Here".$row['BlockId'].$row['PhcId'].$row['HscId']);
