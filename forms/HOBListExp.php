...
//}}}
	...
	$filename = "HOB_List_".date('d-m-Y') . ".xls";			
	  ...
	  if(!empty($developer_records)) {
		...
		$h = array("S.No", "RCHID (PICME) No.","AN Registered Date","Block","PHC","HSC"," VP / TP / Mpty","Village / Ward","Resident/Visitor","Mother Name","Age","Husband Name", "Mobile No","Mother DOB", "Obstetric score","LMP","EDD","Living Children");
