...
if (! empty($_POST["addDelivery"])) {
 ...
 $hebBdate = $_POST["hebBdate"]; $injuction = $_POST["injuction"]; 
  ...
  noOfLiveBirth, noOfStillBirth, infantId, birthDetails, birthWeight, birthHeight, DelayedCClamping, PHCskintoskinContact, 
  breastfeedInitiated, admittedSncu, PHCsncudate, PHCsncuAreaName, PHCsncuOutcome, Dischargedate, Dischargetime, bcgdate, 
    ...
    ?>
            ...
            <div class="row">
                        <div class="col-6 mb-3">
                          ...
                          <select name="picmeno" required id="picmeno" class="form-select picmeNo">
                           <?php   
