...
<?php
  $listQry = "SELECT mh.picmeno,ec.motheraadhaarid,mh.id,mh.lmpdate,mh.edddate,mh.reg12weeks,ec.motheraadhaarname,mh.createdBy,ec.BlockId,ec.PhcId,ec.HscId FROM medicalhistory mh WHERE mh.status=1";
  $private = "";
  $orderQry = "";
