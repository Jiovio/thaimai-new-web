...
<?php
  $listQry = "SELECT DISTINCT(mh.picmeno),mh.id,mh.lmpdate,mh.edddate,mh.reg12weeks,ec.motheraadhaarname FROM medicalhistory mh JOIN ecregister ec on ec.picmeNo=mh.picmeno WHERE mh.status=1";
