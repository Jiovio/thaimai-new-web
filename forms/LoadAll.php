...
$HrCntmq = mysqli_query($conn,"SELECT DISTINCT(hr.picmeNo) as HrCnt from highriskmothers hr JOIN ecregister ec on hr.picmeNo=ec.picmeno WHERE hr.status=1 group by hr.picmeNo;");
