...
$id =0;
 ...
 if (! empty($_POST["editpostnatal"])) {
    ...
    if (!empty($query)) { ?> 
        <div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button><h4><i class="icon fa fa-check"></i>Update Successfully</h4></div>
...
if (isset($_GET['del'])) {
    ...
    header('location: PostnatalVisit.php');
  }
?>
<!-- Content wrapper -->
