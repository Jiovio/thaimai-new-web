...
$checkvaliduser = $db->prepare("SELECT * FROM ecregister WHERE BlockId='".$data->block."' AND PhcId='".$data->phc."' AND HscId='".$data->hsc."' AND status IN(1,2,3,4,5,6) ORDER BY id ASC");
