...
$checkvaliduser = $db->prepare("SELECT * FROM ecregister WHERE ecfrno='".$data->ecfrno."' AND BlockId='".$data->block."' AND PhcId='".$data->phc."' AND HscId='".$data->hsc."' AND status=1 ORDER BY id ASC");
