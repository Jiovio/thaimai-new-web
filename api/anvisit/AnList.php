...
$checkvaliduser = $db->prepare("SELECT * FROM antenatalvisit av join ecregister ec on ec.motheraadhaarid=av.motheraadhaarid WHERE ec.BlockId='".$data->block."' AND ec.PhcId='".$data->phc."' AND ec.HscId='".$data->hsc."' AND av.status=1");
