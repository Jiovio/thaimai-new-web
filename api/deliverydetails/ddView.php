...
$checkvaliduser = $db->prepare("SELECT * FROM deliverydetails dd JOIN ecregister ec ON ec.picmeNo=dd.picmeno WHERE ec.BlockId='".$data->block."' AND ec.PhcId='".$data->phc."' AND ec.HscId='".$data->hsc."' AND dd.picmeno='".$data->picmeno."' AND dd.status=1");
