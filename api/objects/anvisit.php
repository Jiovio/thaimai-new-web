...
class AnVisit {
    ...
    function createantenatalvisit() {
        ...
        if ($mvalidchecknum !="") {
            ...
            urineTestStatus='" . $this->urineTestStatus . "',urineSugarPresent='" . $this->urineSugarPresent . "', urineAlbuminPresent='" . $this->urineAlbuminPresent . "', fastingSugar='" . $this->fastingSugar . "',
            ...
            Td2Dose='" . $this->Td2Dose . "',TdBoosterDate='" . $this->TdBoosterDate . "', 
            ...
            sizeUterusinWeeks='" . $this->sizeUterusinWeeks . "',methodofConception='" . $this->methodofConception . "',symptomsHighRisk='" . $this->symptomsHighRisk . "',
            ...
            usgTakenStatus='" . $this->usgTakenStatus . "',usgDoneDate='" . $this->usgDoneDate . "', usgScanEdd='" . $this->usgScanEdd . "', usgFundalHeight='" . $this->usgFundalHeight . "',usgSizeUterusWeek='" . $this->usgSizeUterusWeek . "',
            ...
            placenta='" . $this->placenta . "',usgResult='" . $this->usgResult . "',usgreport='" . $this->usgreport . "',usgRemarks='" . $this->usgRemarks . "',
    ...
    function editantenatalvisit() {
        ...
        if ($mvalidchecknum !="") {
            ...
            lT2='" . $this->lT2 . "',usgFHRT2='" . $this->usgFHRT2 . "', usgFPT2='" . $this->usgFPT2 . "', usgFMT2='" . $this->usgFMT2 . "',
            lT3='" . $this->lT3 . "',usgFHRT3='" . $this->usgFHRT3 . "', usgFPT3='" . $this->usgFPT3 . "', usgFMT3='" . $this->usgFMT3 . "',
            placenta='" . $this->placenta . "',usgResult='" . $this->usgResult . "',usgRemarks='" . $this->usgRemarks . "',usgreport='" . $this->usgreport . "',bloodTransfusion='" . $this->bloodTransfusion . "',bloodTransfusionDate='" . $this->bloodTransfusionDate . "',
